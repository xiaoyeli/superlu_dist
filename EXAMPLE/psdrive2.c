 ...
 *    mpiexec -n <np> psdrive2 -r <proc rows> -c <proc columns> g20.rua
 * </pre>
 */
...
int main(int argc, char *argv[])
{
    ...
    psinf_norm_error(iam, m_loc, nrhs, b, ldb, xtrue, ldx, &grid);
    ...
    psinf_norm_error(iam, m_loc, nrhs, b1, ldb, xtrue1, ldx, &grid);
