...
/*! @file
 * \brief Driver program for PSGSSVX3D_CSC_VBATCH2 example
 *
 * <pre>
 ...
 * =======
 *
 * The driver program PSDRIVE3D_VBATCH2.
 *
 * This example illustrates how to use PSGSSVX3D_CSC_VBATCH2 to solve a batch
 ...
 * reuses, through the svbatch_ctx_t context:
...
main (int argc, char *argv[])
{
	...
	psgssvx3d_csc_vbatch2(&options, &ctx, batchCount,
