...
// #define enable_gsofa 1
  
#define ROOT     (neqns)

 void test_print_chol()
{
    printf("Testing the chol file ADDITION!\n");
}
...
// int_t cholnzcnt(int_t neqns, int_t *xadj_begin, int_t *xadj_end, int_t *adjncy,
//         int_t *perm, int_t *invp, int_t *etpar, 
//         int_t *colcnt, int_t* rowcnt, int_t *nlnz, int_t *part_super_L)
// {
...
//     /* Work arrays */
//     // int_t *rowcnt = intMalloc_dist(neqns);
//     int_t *set    = intMalloc_dist(neqns);
//     int_t *prvlf  = intMalloc_dist(neqns);
//     int_t *level  = intMalloc_dist(neqns + 1);    /* length n+1 */
//     int_t *weight = intMalloc_dist(neqns + 1);    /* length n+1 */
//     int_t *fdesc  = intMalloc_dist(neqns + 1);    /* length n+1 */
//     int_t *nchild = intMalloc_dist(neqns + 1);    /* length n+1 */
//     int_t *prvnbr = intMalloc_dist(neqns);
...
//         jstrt = xadj_begin[oldnbr];
//         jstop = xadj_end[oldnbr];
//         // jstrt = xadj[oldnbr];
//         // jstop = xadj[oldnbr + 1];
