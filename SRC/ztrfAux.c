				      ...
				      )
{
    ...
    zLUValSubBuf_t *LUvsb = (zLUValSubBuf_t *) SUPERLU_MALLOC(sizeof(zLUValSubBuf_t));
    ...
    ztrf3Dpartition_t*  trf3Dpartition = (ztrf3Dpartition_t *) SUPERLU_MALLOC(sizeof(ztrf3Dpartition_t));
