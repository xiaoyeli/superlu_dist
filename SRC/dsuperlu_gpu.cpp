...
void Scatter_GPU_kernel(
    ...
    dLUstruct_gpu_t * A_gpu, sycl::nd_item<3>& item,
...
int dfree_LUstruct_gpu (dLUstruct_gpu_t * A_gpu, dsluGPU_t *sluGPU)
{
...
// #endif
    ...
    q->memset( A_gpu->LnzvalVec, 0, l_val_len * sizeof(double) );
    ...
    q->memset( A_gpu->UnzvalVec, 0, u_val_len * sizeof(double) );
    ...
    tmp_ptr = (void *)sycl::malloc_device(sizeof(dLUstruct_gpu_t), *q);
    *dA_gpu = (dLUstruct_gpu_t *) tmp_ptr;
    q->memcpy( *dA_gpu, A_gpu, sizeof(dLUstruct_gpu_t) );
