...
void dPrint_CompCol_triplet(SuperMatrix *A)
{
...
void file_dPrint_NCPformat_triplet(FILE *fp, SuperMatrix *A)
{
    ...
    //    printf("\nend triplet matrix\n ");
} /* end file_dPrint_NCPformat_triplet */
...
int dcheckArr(double *A, double *B, int n)
{
	for (int i = 0; i < n; i++)
	{
