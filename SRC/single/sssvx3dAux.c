 ...
 */
void sscale_distributed_matrix(int_t rowequ, int_t colequ, int_t m, int_t n,
    ...
    int_t colequ)
{
    ...
    // sScalePermstruct_t* ScalePermstruct = A->ScalePermstruct;
    // sLUstruct_t* LUstruct = A->LUstruct;
