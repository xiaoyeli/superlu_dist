...
*/
    ...
    allocBcastArray ( &(ScalePermstruct->R), m*sizeof(float),
        0, grid3d->zscp.comm);
    allocBcastArray ( &(ScalePermstruct->C), n*sizeof(float),
        0, grid3d->zscp.comm);
...
#else
    allocBcastArray( &(Astore->nzval), Astore->nnz_loc*sizeof(float),
        0, grid3d->zscp.comm);
