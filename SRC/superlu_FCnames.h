...
#define f_Destroy_LU_SOLVE_struct      FC_GLOBAL(f_destroy_lu_solve_struct,F_DESTROY_LU_SOLVE_STRUCT)
#define f_Destroy_LU_SOLVE_struct_3d   FC_GLOBAL(f_destroy_lu_solve_struct_3d,F_DESTROY_LU_SOLVE_STRUCT_3D)
