...
)
{
    ...
    if ((bid==0) && (tid==0)) {
            ...
            //if (tid==0) printf("(%d) d_launch_flag=%d,d_nfrecv=%d\n",mype,d_launch_flag[0],d_nfrecv[0]);
            //__syncthreads();
