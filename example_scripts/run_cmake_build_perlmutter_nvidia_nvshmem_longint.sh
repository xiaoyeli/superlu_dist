...
cmake .. \
  ...
  -DTPL_PARMETIS_INCLUDE_DIRS="/global/cfs/cdirs/m2957/liuyangz/my_software/parmetis-4.0.3-longint/include;/global/cfs/cdirs/m2957/liuyangz/my_software/parmetis-4.0.3-longint/metis/include" \
  -DTPL_PARMETIS_LIBRARIES="/global/cfs/cdirs/m2957/liuyangz/my_software/parmetis-4.0.3-longint/build/Linux-x86_64/libparmetis/libparmetis.so;/global/cfs/cdirs/m2957/liuyangz/my_software/parmetis-4.0.3-longint/build/Linux-x86_64/libmetis/libmetis.so" \
