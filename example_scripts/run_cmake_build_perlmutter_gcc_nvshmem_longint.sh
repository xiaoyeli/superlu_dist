...
cmake .. \
  ...
  -DTPL_NVSHMEM_LIBRARIES="-L${CUDA_HOME}/lib64/stubs/ -lnvidia-ml -L/usr/lib64 -lgdrapi -lstdc++ -L/opt/cray/libfabric/2.3.1/lib64 -lfabric -L${NVSHMEM_HOME}/lib -lnvshmem" \
