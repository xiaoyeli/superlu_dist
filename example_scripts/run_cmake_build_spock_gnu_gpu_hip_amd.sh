...
export PARMETIS_ROOT=/ccs/home/liuyangz/my_software/parmetis-4.0.3_spock_gcc
...
cmake .. \
	...
	-DCMAKE_C_FLAGS="-Wno-format -Wno-unused-value -Wno-return-type -Wno-unsequenced   -Wno-switch -Wno-parentheses -DPRNTlevel=1 -DPROFlevel=1 -DDEBUGlevel=0 "
make pddrive
make pddrive3d			
