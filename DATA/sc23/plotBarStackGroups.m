function [] = plotBarStackGroups(stackData, groupLabels,labelbar,axisticksize)
...
for i=1:NumStacksPerGroup
    ...
    if(labelbar==1)
        xtips1 = h(i,end).XEndPoints;
        ytips1 = h(i,end).YEndPoints;
        labels1 = string(ytips1);
        tts=text(xtips1,ytips1,labels1,'HorizontalAlignment','center',...
        'VerticalAlignment','bottom');
        for tt=1:length(tts)
            set(tts(tt), 'FontName','Times New Roman','fontsize',axisticksize);
        end
    end
end
hold off;
