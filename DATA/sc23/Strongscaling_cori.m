...
% npzs = [1 2 4 8 16 32 ];
% nprows_all = [8 8 4 4 2 2 ; 16 8 8 4 4 2 ; 16 16 8 8 4 4 ; 32 16 16 8 8 4  ];
% npcols_all = [16 8 8 4 4 2 ; 16 16 8 8 4 2 ; 32 16 16 8 8 4 ; 32 32 16 16 8 8  ];
...
%     ylim([0,2.2]);
    ...
    legs{1,2} = ['$P_z$=2 Baseline'];
    legs{1,3} = ['$P_z$=4 Baseline'];
    legs{1,4} = ['$P_z$=8 Baseline'];
    legs{1,5} = ['$P_z$=16 Baseline'];
    legs{1,6} = ['$P_z$=32 Baseline'];

    legs{1,7} = ['$P_z$=1 New'];
    legs{1,8} = ['$P_z$=2 New'];
    legs{1,9} = ['$P_z$=4 New'];
    legs{1,10} = ['$P_z$=8 New'];
    legs{1,11} = ['$P_z$=16 New'];
    legs{1,12} = ['$P_z$=32 New'];
