...
#spack load hpctoolkit@2019.08.14%gcc@7.4.0~all-static~bgq~cray~cuda+mpi~papi
...
# for MAT in Ga19As19H42.mtx   
  do
    ...
    do
	mpirun  -n $CORE_VAL /home/administrator/Desktop/software/hpctoolkit/install/bin/hpcrun -t -e REALTIME -o ${MAT}_OMP_${OMP_NUM_THREADS} $FILE -c $NCOL -r $NROW $INPUT_DIR/$MAT | tee -a $OUTPUT
	done	 	
	
	/home/administrator/Desktop/software/hpctoolkit/install/bin/hpcstruct ./EXAMPLE/pddrive
	/home/administrator/Desktop/software/hpctoolkit/install/bin/hpcprof -S ./pddrive.hpcstruct -o ${MAT}_OMP_${OMP_NUM_THREADS}_dat -I/$pwd/../SRC/'*' ${MAT}_OMP_${OMP_NUM_THREADS}
